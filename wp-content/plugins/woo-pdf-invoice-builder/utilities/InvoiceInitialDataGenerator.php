...
*/
            ...
            $initialData->FormattedInvoiceNumber=$this->FormatNumber($initialData->InvoiceNumber,$format);
            \update_post_meta($orderId,'_WCPDF_INVOICE_NUMBER_'.$invoiceId,$initialData->FormattedInvoiceNumber);
            \update_post_meta($orderId,'_WCPDF_INVOICE_DATE_'.$invoiceId,$initialData->Date);
