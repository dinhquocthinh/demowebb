 ...
 * Version: 1.2.86
 * Text Domain: PDF Invoice Builder for WooCommerce
        ...
        if($typenow=='shop_order')
        {
            ...
            wp_localize_script('rnwpdfi-metabox','rnpdfinvOrderParams',
                array(
                    ...
                    'GenerationURL'=>wp_nonce_url( get_admin_url( null,"admin-ajax.php?action=rednao_wcpdfinv_generate_pdf&orderid=" . get_the_ID() ), 'rednao_wcpdfinv_generate_pdf_'.get_the_ID() ),
                    'OrderId'=>get_the_ID(),
                    ...
                    'EditInvoiceNumberNonce'=>wp_create_nonce('edit_number_'.get_the_ID()),
                    'IsPr'=>self::IsPR(),
                    'Email'=>$to
                ));
        }
