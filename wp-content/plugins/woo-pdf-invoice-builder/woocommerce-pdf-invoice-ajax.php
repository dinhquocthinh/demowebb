...
final class RednaoWooCommercePDFInvoiceAjax{
    ...
    public function Export(){
        ...
        $invoiceData=$wpdb->get_row("select extensions,conditions,attach_to,invoice_id,name,options,type,html,pages from ".RednaoWooCommercePDFInvoice::$INVOICE_TABLE." where invoice_id=".$_POST['pageId']);
        if($invoiceData==null){
            return;
        }
