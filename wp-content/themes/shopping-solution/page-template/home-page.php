                          ...
                          <div class="inner_carousel">
                            <div class="carousel-content p-3">
                              ...
                              <?php if( get_theme_mod('ecommerce_solution_slider_text',true) != ''){ ?>
                                <p><?php $shopping_solution_excerpt = get_the_excerpt(); echo esc_html( ecommerce_solution_string_limit_words( $shopping_solution_excerpt, esc_attr(get_theme_mod('ecommerce_solution_slider_excerpt_number','15')))); ?></p>
                              <?php } ?>
