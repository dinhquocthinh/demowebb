...
if ( ! class_exists( 'Storefront_Ecommerce_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Storefront_Ecommerce_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Storefront_Ecommerce_WPTT_WebFont_Loader( $url );
