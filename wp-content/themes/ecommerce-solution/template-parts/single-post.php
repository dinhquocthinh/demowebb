	...
	<?php if( get_theme_mod( 'ecommerce_solution_single_post_date',true) != '' || get_theme_mod( 'ecommerce_solution_single_post_author',true) != '' || get_theme_mod( 'ecommerce_solution_single_post_comment',true) != '') { ?>
		<div class="metabox p-2 p-3 mb-3">
	      	...
	      	<?php if( get_theme_mod( 'ecommerce_solution_single_post_author',true) != '') { ?>
	        	<?php echo esc_html( get_theme_mod('ecommerce_solution_single_post_meta_seperator') ); ?><span class="entry-author me-2"><i class="<?php echo esc_attr(get_theme_mod('ecommerce_solution_single_post_author_icon','fas fa-user')); ?> mx-2"></i><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' )) ); ?>"><?php the_author(); ?><span class="screen-reader-text"><?php the_title(); ?></span></a></span>
	      	<?php }?>
	      	<?php if( get_theme_mod( 'ecommerce_solution_single_post_comment',true) != '') { ?>
	        	<?php echo esc_html( get_theme_mod('ecommerce_solution_single_post_meta_seperator') ); ?><span class="entry-comments me-2"><i class="<?php echo esc_attr(get_theme_mod('ecommerce_solution_single_post_comment_icon','fas fa-comments')); ?> mx-1"></i> <?php comments_number( __('0 Comment', 'ecommerce-solution'), __('0 Comments', 'ecommerce-solution'), __('% Comments', 'ecommerce-solution') ); ?></span>
	      	<?php }?>
	      	<?php if( get_theme_mod( 'ecommerce_solution_single_post_time',false) != '' ) { ?>
          		<?php echo esc_html( get_theme_mod('ecommerce_solution_single_post_meta_seperator') ); ?><span class="entry-time me-2"><i class="<?php echo esc_attr(get_theme_mod('ecommerce_solution_single_post_time_icon','fas fa-clock')); ?> mx-2"></i> <?php echo esc_html( get_the_time() ); ?></span>
	        <?php }?>
	    </div>
	<?php }?>
