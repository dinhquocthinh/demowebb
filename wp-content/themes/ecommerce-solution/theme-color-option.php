<?php
	...
	$ecommerce_solution_custom_css .='.primary-navigation a:hover, .primary-navigation ul.sub-menu li a:hover{';
	...
	$ecommerce_solution_custom_css .='.primary-navigation ul.sub-menu li a{';
