  ...
  { ?>
    <?php if ($content == 'text') { ?>
      <div class='content-html'>
        <?php echo esc_html(get_theme_mod('big_store_col1_texthtml',  __('Add your content here', 'th-big-shop'))); ?>
      </div>
      ...
      <?php
        ...
        <a href="<?php echo esc_url(admin_url('nav-menus.php')); ?>"><?php esc_html_e('Assign Above header menu', 'th-big-shop'); ?></a>
      <?php }
      ...
      <div class="content-widget">
        <?php if (is_active_sidebar('top-header-widget-col1')) {
          ...
          <a href="<?php echo esc_url(admin_url('widgets.php')); ?>"><?php esc_html_e('Add Widget', 'th-big-shop'); ?></a>
        <?php } ?>
      </div>
...
if (!function_exists('big_store_top_header_conetnt_col2')) {
  ...
  { ?>
    <?php if ($content == 'text') { ?>
      <div class='content-html'>
        <?php echo esc_html(get_theme_mod('big_store_col2_texthtml',  __('Add your content here', 'th-big-shop'))); ?>
      </div>
      <?php } elseif ($content == 'menu') {
      if (has_nav_menu('big-store-above-menu')) { ?>
        <!-- Menu Toggle btn-->
...
if (!function_exists('big_store_top_header_conetnt_col3')) {
  ...
  { ?>
    <?php if ($content == 'text') { ?>
      <div class='content-html'>
        <?php echo esc_html(get_theme_mod('big_store_col3_texthtml',  __('Add your content here', 'th-big-shop'))); ?>
      </div>
      <?php } elseif ($content == 'menu') {
      if (has_nav_menu('big-store-above-menu')) { ?>
        <!-- Menu Toggle btn-->
...
if (!function_exists('big_store_below_header_markup')) {
  ...
  {
    $main_header_layout = get_theme_mod('big_store_main_header_layout', 'mhdrtwo');
                  ...
                  <div class="header-support-icon">
                    <?php if( class_exists( 'WooCommerce' ) &&get_theme_mod('big_store_whislist_mobile_disable',false) != true){ ?>
                      <a class="whishlist" href="<?php echo esc_url(big_store_whishlist_url()); ?>">
                        <span class="th-icon th-icon-heartline"></span><span><?php _e('Wishlist', 'th-big-shop'); ?></span></a>
                    <?php } ?>
...
function big_store_header_icon()
{
  if (class_exists('WooCommerce')) {
    ...
    <div class="header-icon">
      <?php
      if (get_theme_mod('big_store_main_header_layout','mhdrtwo') == 'mhdrtwo') { ?>

        <?php  if ( shortcode_exists('tapsp') ){ ?>
          <a class="prd-search-icon" >
         <?php echo do_shortcode('[tapsp layout="icon_style"]');  ?>
          </a>
      <?php  }elseif( shortcode_exists('th-aps') ){ ?>
            <a class="prd-search-icon" >
          <?php echo do_shortcode('[th-aps layout="icon_style"]'); ?>
            </a>
     <?php   } ?>
          ...
          <div class="mobile-nav-tabs">
            <ul>
              <li class="primary active" data-menu="primary">
                <a href="#mobile-nav-tab-menu"><?php _e('Menu', 'th-big-shop'); ?></a>
              </li>

              <li class="categories" data-menu="categories">
                <a href="#mobile-nav-tab-category"><?php _e('Categories', 'th-big-shop'); ?></a>
              </li>
...
function big_store_th_advance_product_search(){
              ...
              if ( shortcode_exists('th-aps') ){
                ...
                <a target="_blank" class="plugin-active-msg" href="<?php echo esc_url($url);?>">
                  ...
                  <?php _e('Please Install "th advance product search" Plugin','th-big-shop');?>
