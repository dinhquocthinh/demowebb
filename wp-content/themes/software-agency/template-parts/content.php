          ...
          <?php if( get_theme_mod( 'software_agency_toggle_postdate',true) == 1 || get_theme_mod( 'software_agency_toggle_author',true) == 1 || get_theme_mod( 'software_agency_toggle_comments',true) == 1 || get_theme_mod( 'software_agency_toggle_time',true) == 1) { ?>
            <div class="post-info p-2 mb-3">
              ...
              <?php if(get_theme_mod('software_agency_toggle_author',true)==1){ ?>
                <span><?php echo esc_html(get_theme_mod('software_agency_meta_field_separator', '|'));?></span> <i class="<?php echo esc_attr(get_theme_mod('software_agency_toggle_author_icon','fas fa-user')); ?>"></i><span class="entry-author"><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' )) ); ?>"><?php the_author(); ?><span class="screen-reader-text"><?php the_author(); ?></span></a></span>
              <?php } ?>

              <?php if(get_theme_mod('software_agency_toggle_comments',true)==1){ ?>
                <span><?php echo esc_html(get_theme_mod('software_agency_meta_field_separator', '|'));?></span> <i class="<?php echo esc_attr(get_theme_mod('software_agency_toggle_comments_icon','fa fa-comments')); ?>" aria-hidden="true"></i><span class="entry-comments"><?php comments_number( __('0 Comment', 'software-agency'), __('0 Comments', 'software-agency'), __('% Comments', 'software-agency') ); ?></span>
              <?php } ?>

              <?php if(get_theme_mod('software_agency_toggle_time',true)==1){ ?>
                <span><?php echo esc_html(get_theme_mod('software_agency_meta_field_separator', '|'));?></span> <i class="<?php echo esc_attr(get_theme_mod('software_agency_toggle_time_icon','fas fa-clock')); ?>"></i><span class="entry-time"><?php echo esc_html( get_the_time() ); ?></span>
              <?php } ?>
            </div>
          <?php } ?>
          <p class="mb-0">
