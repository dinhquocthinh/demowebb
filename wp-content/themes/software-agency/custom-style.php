<?php
	...
	$software_agency_button_letter_spacing = get_theme_mod('software_agency_button_letter_spacing',14);
	$software_agency_custom_css .='.post-main-box .more-btn a{';
	...
	if($software_agency_footer_background_image != false){
		$software_agency_custom_css .='#footer{';
			$software_agency_custom_css .='background: url('.esc_attr($software_agency_footer_background_image).');';
		$software_agency_custom_css .='}';
	}
